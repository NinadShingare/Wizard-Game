...
public class Game extends Canvas implements Runnable{
	...
	public Game() {
		...
		new Window(1000,863, "Wizard Game", this);
		start();
		...
		level = loader.loadImage("/wizard_level1.png");
...
//		g.fillRect(0, 0, 1000, 563);
		...
		g.drawString("HP :"+ hp, 5, 15);
		
		g.setColor(Color.white);
		g.drawString("Score :"+ score, 70, 15);
		//health bar
		g.setColor(Color.gray);
		g.fillRect(5, 20, 200, 32);
		g.setColor(Color.green);
		g.fillRect(5, 20, hp*2, 32);
		g.setColor(Color.black);
		g.drawRect(5, 20, 200, 32);
